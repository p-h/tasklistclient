...
describe("App", () => {
  it("has a heading", () => {
    expect($(view).find("heading").length).toBeGreaterThan(0);
    expect($(view).find("heading h1").length).toBeGreaterThan(0);
  })

  it("has containers with two buttons", () => {
    expect($(view).find("div > button#new-button").length).toBeGreaterThan(0);
    expect($(view).find("div > button#save-button").length).toBeGreaterThan(0);
  })
